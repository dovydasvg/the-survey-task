<template>
    <app-layout>
        ...
        <button type="submit" class="p-4 bg-gray-400 rounded font-bold m-4" v-if="questions.current_page !== questions.last_page && questions.data != 0" >Next</button>
        <button type="submit" class="p-4 bg-gray-400 rounded font-bold m-4" v-if="questions.current_page === questions.last_page" >Done</button>
        </div>
        </form>
    </app-layout>
</template>
